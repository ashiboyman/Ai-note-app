...
import { Bot, Expand, Minimize, Send, Trash, X, XCircle } from "lucide-react";
...
function ErrorMessage() {
    return (
        <div className="flex items-center gap-2 py-2 px-3 bg-destructive/10 text-destructive rounded-md">
